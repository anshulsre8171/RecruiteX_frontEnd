...
function BlogSection() {
  return (
    <>
      <div className="container-fluid blog-container p-3">
        ...
        <div className="row blog-row mx-auto px-3 px-md-5">
          <div className="col-sm-12 col-md-5 blog-card border rounded">
            <div className="blog-image-wrapper">
              <div className="date-badge1 w-25">
                <span className="mt-2">24</span><br/>
                <span>Now</span>
              </div>
              <img src="/home-blog1.jpg" alt="Blog 1" className="blog-img p-0 m-0" />
            </div>
